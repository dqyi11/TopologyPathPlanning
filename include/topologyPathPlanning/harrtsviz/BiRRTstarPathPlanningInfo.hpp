#ifndef TOPOLOGYPATHPLANNING_HARRTS_BIRRTSTARPATHPLANNINGINFO_HPP
#define TOPOLOGYPATHPLANNING_HARRTS_BIRRTSTARPATHPLANNINGINFO_HPP
...
namespace harrts {
  ...
  public:
    ...
    static double calcCost( POS2D pos_a, POS2D pos_b, double** pp_distribution, void* tree ) {
      double cost = 0.0;
...
#endif //  TOPOLOGYPATHPLANNING_HARRTS_BIRRTSTARPATHPLANNINGINFO_HPP
